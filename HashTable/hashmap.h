...
class HashMap
{
	public:
		...
		class iterator {
			public:
				iterator(const typename HashMap<KeyType, ValueType>::iterator& other):
			...
			private:
				HashMap<KeyType, ValueType>* parent;
				typename std::list<Entry>::iterator position;
				size_t index;
				bool end;
								
				iterator(HashMap<KeyType, ValueType>* parent, size_t& index, const typename std::list<Entry>::iterator& position):
		...
		class const_iterator : private iterator {
			public:
				const_iterator(const typename HashMap<KeyType, ValueType>::iterator& other):
						parent(other.parent), index(other.index), end(false) {}
